...
package struct GlyphEntry {
    package var atlasOrigin: SIMD2<Float>
    package var atlasSize: SIMD2<Float>
    package var bearing: SIMD2<Float>
    package var advance: Float
    ...
    package var isColor: Bool = false
}
...
package struct GlyphStyle: OptionSet, Hashable {
    package let rawValue: Int
    package init(rawValue: Int) { self.rawValue = rawValue }
    package static let bold   = GlyphStyle(rawValue: 1 << 0)
    package static let italic = GlyphStyle(rawValue: 1 << 1)
    /// regular, bold, italic, bold-italic
    package static let faceCount = 4
}

package final class GlyphAtlas {
    ...
    package let colorTexture: MTLTexture
    package let font: CTFont
    package let width: Int
    package let height: Int
    package let colorWidth: Int
    package let colorHeight: Int
    ...
    package let strokeWeight: Double
    ...
    package init(device: MTLDevice, font: CTFont, strokeWeight: Double,
    ...
    package func entry(for scalar: Unicode.Scalar, style: GlyphStyle = []) -> GlyphEntry? {
