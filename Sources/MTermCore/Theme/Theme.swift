...
package enum ThemeAppearance: String, Codable, CaseIterable {
    case light, dark
}
...
package struct PackedColor: Hashable {
    package let value: UInt32

    package init(_ value: UInt32) { self.value = value }

    package init(_ c: SIMD4<Float>) {
...
package struct Theme: Identifiable, Equatable {
    package let id: String
    package let name: String
    package let appearance: ThemeAppearance

    package let background: SIMD4<Float>
    package let foreground: SIMD4<Float>
    package let cursor: SIMD4<Float>
    ...
    package var linkAccent: SIMD4<Float> {
        ansi.indices.contains(4) ? ansi[4] : foreground
    }

    package static func rgb(_ hex: UInt32, alpha: Float = 1.0) -> SIMD4<Float> {
...
extension Theme {
    package static let builtin: [Theme] = [
    ...
    package static let mTermDark = Theme(
        id: "mterm-dark",
        name: "mTerm Dark",
        appearance: .dark,
    ...
    package static let mTermLight = Theme(
        id: "mterm-light",
        name: "mTerm Light",
        appearance: .light,
    ...
    package static let tomorrowNight = Theme(
        id: "tomorrow-night",
        name: "Tomorrow Night",
        appearance: .dark,
    ...
    package static let solarizedDark = Theme(
        id: "solarized-dark",
        name: "Solarized Dark",
        appearance: .dark,
    ...
    package static let solarizedLight = Theme(
        id: "solarized-light",
    ...
    package static let dracula = Theme(
        id: "dracula",
        name: "Dracula",
        appearance: .dark,
    ...
    package static let gruvboxDark = Theme(
        id: "gruvbox-dark",
        name: "Gruvbox Dark",
        appearance: .dark,
    ...
    package static let pencilLight = Theme(
        id: "pencil-light",
        name: "Pencil Light",
        appearance: .light,
...
package enum ThemeImportError: LocalizedError {
    case unreadableFile
    case malformedPlist
    case missingColors
...
extension Theme {
    ...
    package static var themesDirectory: URL? {
    ...
    package static func loadImported() -> [Theme] {
    ...
    package static func importItermColors(from url: URL) throws -> Theme {
        let data: Data
