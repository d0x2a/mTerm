...
package enum AppearanceMode: String, Codable, CaseIterable, Identifiable {
...
package struct AppSettings: Codable, Equatable {
    package var appearanceMode: AppearanceMode = .system
    package var lightThemeId: String = Theme.mTermLight.id
    package var darkThemeId: String = Theme.mTermDark.id
    package var fontFamily: String = FontCatalog.defaultFamily
    package var fontSize: Double = 14
    ...
    /// within 0.2%.
    package var strokeWeight: Double = 1.0
    ...
    package var lineHeight: Double = 1.15
    ...
    /// the hub.
    package var confirmClearScreen: Bool = true
    ...
    package var notificationsEnabled: Bool = true
    ...
    /// docs/BENCHMARKS.md.
    package var scrollbackLines: Int = 10_000
    ...
    /// extra entry.
    package static let scrollbackChoices = [1_000, 5_000, 10_000, 25_000, 50_000, 100_000]
    ...
    package var shellIntegrationEnabled: Bool = true

    /// Profile ⌘T opens. nil means the first profile on disk.
    package var defaultProfileId: String? = nil
...
extension AppSettings {
    ...
    package static func load() -> AppSettings {
        guard let url = url,
    ...
    package static func save(_ settings: AppSettings) {
        guard let url = url,
