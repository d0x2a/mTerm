...
package enum TmuxEvent: Equatable {
...
package final class TmuxControlClient {
    package init() {}

    /// Called for each event, in arrival order.
    package var onEvent: ((TmuxEvent) -> Void)?
    ...
    package func feed(_ bytes: ArraySlice<UInt8>) {
    ...
    package static func unescape(_ s: String) -> [UInt8] {
        var out: [UInt8] = []
    ...
    package static func hexKeys(_ bytes: [UInt8]) -> String {
