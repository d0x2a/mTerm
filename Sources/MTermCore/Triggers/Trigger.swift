...
package enum ClickAction: Codable, Equatable {
    case openURL
...
package enum TriggerStyle: String, Codable, CaseIterable, Identifiable {
...
package struct Trigger: Identifiable, Codable, Equatable {
    package let id: UUID
    package var name: String
    package var pattern: String
    /// Background tint color (RGBA, 0..1).
    package var colorR: Float
    package var colorG: Float
    package var colorB: Float
    package var colorA: Float
    package var style: TriggerStyle
    package var clickAction: ClickAction?
    ...
    package var color: SIMD4<Float> { SIMD4(colorR, colorG, colorB, colorA) }
}
...
extension Trigger {
    ...
    package static let hyperlink = Trigger(name: "Hyperlink",
                                   pattern: "",
    ...
    package static let urlID  = UUID(uuidString: "6D546572-6D00-4000-8000-000000000001")!
    package static let pathID = UUID(uuidString: "6D546572-6D00-4000-8000-000000000002")!
    ...
    package static let builtins: [Trigger] = [
        Trigger(id: urlID,
                name: "URL",
                pattern: urlPattern,
                color: SIMD4(0.40, 0.65, 1.00, 1.00),
    ...
    package var isBuiltin: Bool { Trigger.builtinIDs.contains(id) }

    package static let builtinIDs: Set<UUID> = [urlID, pathID]
}
